...
void HttpServer::acceptConnection()
{
    ...
    // 1.2.使用accept4非阻塞接收连接（SOCK_NONBLOCK）
...
{
    // 构造动态响应
    const std::string body = "Hello World1111111111";
    const std::string response =
        "HTTP/1.1 200 OK\r\n"
